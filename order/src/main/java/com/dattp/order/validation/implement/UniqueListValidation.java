...
public class UniqueListValidation implements ConstraintValidator<UniqueListTable,Collection<RequestBookedTableDTO>>{

    @Override
    public boolean isValid(Collection<RequestBookedTableDTO> arg0, ConstraintValidatorContext arg1) {
        System.out.println("======================================================================");
